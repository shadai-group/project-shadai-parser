...
class TextChunker:
    ...
    def chunk_pdf_pages(
        self, pdf_text: str, page_breaks: List[int]
    ) -> List[Dict[str, Any]]:
        """
    ...
    def _generate_chunk_id(
        self, chunk: str, index: int, page_number: Optional[int] = None
    ) -> str:
    ...
    def get_chunk_statistics(self, chunks: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        return {
            ...
            "pages_covered": len(
                set(chunk["page_number"] for chunk in chunks if chunk["page_number"])
            ),
        }
